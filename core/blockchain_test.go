...
func testBrokenChain(t *testing.T, full bool) {
	...
	if full {
		...
		err := testBlockChainImport(chain, blockchain)
		if err == nil {
...
func newGwei(n int64) *big.Int {
	return new(big.Int).Mul(big.NewInt(n), big.NewInt(int64(GWei)))
}
